...
export default function Trades() {
    ...
    useEffect(() => {
        function UpdatePageTitle() {
            document.title = "Trades Concluded";
            ActiveLink("trades");
        }
        UpdatePageTitle();
    }, [])
                ...
                <div id='trade-page'>
                    <div id='trade-page-inner'>
                        <div id='trade-page-header-link'>
                            <Link to="/trades">Ongoing trade</Link>
                            <Link className='active' to="/trades/concluded">Concluded trade</Link>
                        </div>
                        {/* Balance */}
                        <div className='balance-list'>
                            <ul>
                                ...
                                <li>
                                    <div className='balance-desc'>Profit:</div>
                                    <div className='balance-amount'>67.00</div>
                                </li>
                                <li>
                                    <div className='balance-desc'>Deposit:</div>
                                    <div className='balance-amount'>10,000.00</div>
                                </li>

                                <li>
                                    <div className='balance-desc'>Balance</div>
                                    <div className='balance-amount'>10,067.00</div>
                                </li>
                            </ul>
                        </div>
                        {/* End Of Balance */}
